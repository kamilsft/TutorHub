...
export default async function EditStudyPlanPage({ params }: Props) {
      ...
      <div className="container mx-auto max-w-3xl px-4">
        <div className="mb-6 flex items-center justify-between">
          <h1 className="text-2xl font-semibold mb-4">
            Edit Study Plan - {plan.student?.fullName || "Student"}
          </h1>
          <Link
        ...
        <StudyPlanForm
          ...
          onSavedPath="/dashboard/tutor/study-plan/view-plans"
